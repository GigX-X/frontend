...
export default function UserSignIn() {
  ...
  return (
    <div className="animate__animated animate__fadeInDown min-h-screen w-full flex items-center justify-center bg-blue sm:px-6 lg:px-8">
      <div className="animate__animated animate__fadeInUp animate__delay-1s max-w-md w-full h-auto border bg-white p-8 rounded-xl">
        <div>
